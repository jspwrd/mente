...
| --- | --- |
| [`coding_agent.py`](./coding_agent.py) | Program synthesis + library reuse: MENTE synthesizes a Python function for a computation, validates it in a sandbox, and promotes it into a persistent library. Repeat queries of the same shape hit the cached primitive. |
